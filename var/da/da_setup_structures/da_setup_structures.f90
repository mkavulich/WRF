module da_setup_structures
   ...
   use da_control, only : trace_use,vert_evalue,stdout,rootproc, &
      ...
      use_radar_rf, use_radar_rhv, use_radar_rqv, use_3dvar_phy, use_3dvar_dyn,&
      ...
      interpolate_stats, be_eta, thin_rainobs, fgat_rain_flags, use_iasiobs, use_seviriobs, idxdiv
